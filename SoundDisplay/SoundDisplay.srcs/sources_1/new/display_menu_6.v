...
module display_menu_6(
    ...
    reg [15:0]  param01_M_x=9, param01_M_y=15, 
                param01_I_x=15, param01_I_y=15, 
                param01_C_x=19, param01_C_y=15, 
                param01_I1_x=24, param01_I1_y=15, 
                param01_N_x=28, param01_N_y=15, 
                param01_O_x=34, param01_O_y=15, 
                param01_R_x=39, param01_R_y=15, 
                param01_P_x=45, param01_P_y=15, 
                param01_E_x=49, param01_E_y=15, 
                param01_A_x=53, param01_A_y=15, 
                param01_K_x=57, param01_K_y=15, 
                param01_O1_x=63, param01_O1_y=15, 
                param01_N1_x=68, param01_N1_y=15, 
                param01_7_x=74, param01_7_y=15, 
                param01_S_x=79, param01_S_y=15, 
                param01_E1_x=83, param01_E1_y=15, 
                param01_G_x=87, param01_G_y=15, 
    ...
    begin            
        ...
        if ((y >= param01_7_y) && (y < param01_7_y+ 5)) // y value in range
        begin 
            if ((x >= param01_7_x) && (x < param01_7_x+ 3))
            begin 
                if (x == param01_7_x && y - param01_7_y == 0)
                oled_data = color_letter;
                else if (x == param01_7_x+1 && (y - param01_7_y == 0 || y - param01_7_y == 2))
                oled_data = color_letter;
                else if (x == param01_7_x + 2)
                oled_data = color_letter;
            end  
        end
