...
module menu_mode_5(
    ...
    input [3:0] menu_mode,
    output reg done_5, 
    output reg [3:0] option_5,
    output reg led_choice //1: 1pixel, 0: 3pixel
    );
    ...
    begin
        ...
        if (menu_mode == 5 && option_5 == 1 && btnR_flag == 1)
        begin
            option_5 <= 0;
            btnR_flag <= 0;
        end
        if (menu_mode == 5 && option_5 == 0 && btnR_flag == 1)
        begin
            option_5 <= 0;
            btnR_flag <= 0;
        end        
        ...
        if (menu_mode == 5 && option_5 == 0 && btnL_flag == 1)
        begin
            option_5 <= 1;
            btnL_flag <= 0;
        end
        if (menu_mode == 5 && option_5 == 1 && btnL_flag == 1)
        begin
            option_5 <= 1;
            btnL_flag <= 0;
        end      
        ...
        //option selection
        if (menu_mode == 5 && btnC_flag == 1 && flag_count == 0)
        begin
            led_choice <= option_5;
            done_5 <= 1;
            btnC_flag <= 0;
